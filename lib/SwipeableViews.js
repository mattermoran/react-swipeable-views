...
var axisProperties = {
  ...
  transform: {
    ...
    y: function y(translate) {
      return 'translate3d(0px, ' + -translate + '%, 0px)';
    },
    'another-dimension': function y(translate) {
      return translate;
    },
...
var SwipeableViews = function (_Component) {
  ...
  (0, _createClass3.default)(SwipeableViews, [{
    ...
    value: function componentWillMount() {
      ...
      // if (this.props.getTransform) {
      //   this.props.getTransform(0);
      // }
    ...
    value: function setIndexCurrent(indexCurrent) {
      ...
      if (this.containerNode) {
        ...
        // console.log(axisProperties.transform['another-dimension'](indexCurrent * 100));
        if (this.props.getTransform) {
          if (this.prevValue !== Math.floor(axisProperties.transform['another-dimension'](indexCurrent * 100))) {
            this.props.getTransform(Math.floor(axisProperties.transform['another-dimension'](indexCurrent * 100)));
            this.prevValue = Math.floor(axisProperties.transform['another-dimension'](indexCurrent * 100));
          }
        }
      }
    }
    ...
    value: function render() {
      ...
      var _props = this.props,
        ...
        other = (0, _objectWithoutProperties3.default)(_props, ['action', 'getTransform', 'dragging', 'animateHeight', 'animateTransitions', 'axis', 'children', 'containerStyle', 'disabled', 'disableLazyLoading', 'enableMouseEvents', 'hysteresis', 'ignoreNativeScroll', 'index', 'onChangeIndex', 'onSwitching', 'onTransitionEnd', 'resistance', 'slideStyle', 'slideClassName', 'springConfig', 'style', 'threshold']);
      ...
      if (isDragging || !animateTransitions || displaySameSlide) {
        ...
        if (this.props.dragging && this.lastDrag !== isDragging) {
          this.props.dragging(true);
          this.lastDrag = isDragging;
        }
      } else {
        if (this.props.dragging && this.lastDrag !== isDragging) {
...
SwipeableViews.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  getTransform: _propTypes2.default.func,
  dragging: _propTypes2.default.func,
